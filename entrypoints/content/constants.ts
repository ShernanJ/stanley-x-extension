...
export const X_CLIENT_GENERATION_VERSION = '2026-02-24-cache-v5';
export const X_DRAFT_CACHE_PREFIX = 'stanley_x_xdraft_v2_';
export const X_DRAFT_HISTORY_PREFIX = 'stanley_x_xdraft_history_v2_';
...
export const LINKEDIN_DRAFT_STORAGE_PREFIX = 'stanley_x_lastDraft:';
